              ...
              {paginatedData.length > 0 ? paginatedData.map((item) => (
                <tr key={item.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  ...
                  <td className="px-6 py-4 flex justify-end space-x-1">
                    <button onClick={() => handleEditClick(item)} className="p-2 rounded-full text-blue-500 hover:text-blue-700 hover:bg-blue-100 dark:hover:bg-gray-700 transition-colors" aria-label="Edit Pengguna"><i className="fas fa-edit"></i></button>
                    <button onClick={() => handleDeleteClick(item)} className="p-2 rounded-full text-red-500 hover:text-red-700 hover:bg-red-100 dark:hover:bg-gray-700 transition-colors" aria-label="Hapus Pengguna"><i className="fas fa-trash"></i></button>
                  </td>
                </tr>
              )) : (
                  <tr>
    ...
    <div className="space-y-6">
            ...
            <form id="user-form" onSubmit={handleUserSubmit} className="flex-1 min-h-0 overflow-y-auto p-6 space-y-4">
              ...
              {newUserRole === UserRole.TEACHER && (
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <input type="text" name="subject" placeholder="Mata Pelajaran" value={formData.subject} onChange={handleInputChange} className="w-full rounded-md border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700" required />
                </div>
              )}
      ...
      <Card>
          ...
          <div className="flex flex-wrap gap-2 justify-between items-center mb-4">
            ...
            <div className="flex items-center space-x-2">
                <button onClick={() => setIsModalOpen(true)} className="px-4 py-2 text-sm font-medium text-white bg-primary-600 rounded-md hover:bg-primary-700"><i className="fas fa-plus mr-1"></i>Tambah</button>
            </div>
          </div>
          {renderUserTable()}
      </Card>
