              ...
              <div>
                ...
                <div className="flex justify-around">
                  {moodOptions.map(({ mood, icon, color }) => (
                    <button type="button" key={mood} onClick={() => setSelectedMood(mood)} className={`flex flex-col items-center justify-center p-2 w-16 h-16 rounded-lg transition-all transform ${selectedMood === mood ? 'scale-110 ring-2 ring-primary-500' : 'opacity-60 hover:opacity-100 hover:scale-105'}`}>
                ...
                <div key={entry.id} className="p-4 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
                  <div className="flex justify-between items-start">
                    ...
                    <div className="flex items-center space-x-1">
                      <button onClick={() => handleEditJournal(entry)} aria-label="Edit Jurnal" className="p-2 rounded-full text-blue-500 hover:text-blue-700 hover:bg-blue-100 dark:hover:bg-gray-700 transition-colors"><i className="fas fa-edit"></i></button>
                      <button onClick={() => handleDeleteRequest(entry.id)} aria-label="Hapus Jurnal" className="p-2 rounded-full text-red-500 hover:text-red-700 hover:bg-red-100 dark:hover:bg-gray-700 transition-colors"><i className="fas fa-trash"></i></button>
                    </div>
                  </div>
